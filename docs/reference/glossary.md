...
*   **Degraded**: The system is functioning but with reduced capabilities, accuracy, or performance (e.g., scoring without live telemetry, using fallback providers).
...
*   **Use**: "Degraded state" instead of "Self-healing in progress" (unless it is actually healing).

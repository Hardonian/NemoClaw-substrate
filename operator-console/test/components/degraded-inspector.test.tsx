...
describe("DegradedInspector", () => {
  ...
  it("renders reason codes and explanations", () => {
    const states = [makeDegradedState({ category: "degraded", reason: "test reason", affectedSubsystem: "test", severity: "warning", reasonCode: "capability_missing", explanation: "Test explanation", sourceComponent: "test" })];
  ...
  it("shows 'None' for recovery when not available", () => {
    const states = [makeDegradedState({ category: "degraded", reason: "test", affectedSubsystem: "test", severity: "warning", reasonCode: "capability_missing", explanation: "Test", sourceComponent: "test" })];
    render(<DegradedInspector states={states} />);

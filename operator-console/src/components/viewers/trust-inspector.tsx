          ...
          attestations.map((att) => (
            <div key={att.attestationId} className={styles.attestationCard}>
              ...
              <KVTable entries={[
                ...
                { key: "Reason Codes", value: att.reasonCodes.length > 0 ? att.reasonCodes.map(codeLabel) : "None" },
...
const trustColumns: ColumnDef[] = [
  ...
  { key: "reasonCodes", header: "Reason Codes", render: (v) => (v as WorkerTrustReasonCode[]).map(codeLabel).join(", ") },

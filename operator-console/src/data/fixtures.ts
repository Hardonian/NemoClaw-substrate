...
export const sampleEvents: OperationalEvent[] = [
  ...
  makeOperationalEvent({ eventId: "op-005", sequence: 4, category: "degraded", provenance: { requestId: "req-002", receiptId: "receipt-002" }, replayRef: { lineage: ["chat"], replayVersion: "1" }, payload: { degraded: { reason: "remote_timeout" } } }),
